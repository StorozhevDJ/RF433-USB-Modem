...
WriteSingleReg(IOCFG2,0x06);  //GDO2 Output Configuration
WriteSingleReg(IOCFG0,0x0E);  //GDO0 Output Configuration
WriteSingleReg(FIFOTHR,0x47); //RX FIFO and TX FIFO Thresholds
WriteSingleReg(SYNC1,0xF6);   //Sync Word, High Byte
WriteSingleReg(SYNC0,0x8D);   //Sync Word, Low Byte
WriteSingleReg(PKTLEN,0x3F);  //Packet Length
WriteSingleReg(PKTCTRL1,0x40);//Packet Automation Control
WriteSingleReg(PKTCTRL0,0x00);//Packet Automation Control
WriteSingleReg(CHANNR,0x02);  //Channel Number
...
WriteSingleReg(FREQ1,0xAF);   //Frequency Control Word, Middle Byte
WriteSingleReg(FREQ0,0x75);   //Frequency Control Word, Low Byte
WriteSingleReg(MDMCFG4,0xF6); //Modem Configuration
WriteSingleReg(MDMCFG3,0x83); //Modem Configuration
WriteSingleReg(MDMCFG1,0x51); //Modem Configuration
WriteSingleReg(MDMCFG0,0x2E); //Modem Configuration
WriteSingleReg(DEVIATN,0x16); //Modem Deviation Setting
...
WriteSingleReg(WOREVT1,0x00); //High Byte Event0 Timeout
